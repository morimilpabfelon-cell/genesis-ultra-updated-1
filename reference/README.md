...
|---|---|---|---|
| Python | `tools/*.py` | workspace, identidad inmutable, continuidad, contrato host, cripto-digests, simulaciones A→B y negativas | activa |
| JavaScript (Node) | `tools/*.mjs` | workspace, identidad inmutable, contrato host, todos los vectores compartidos, artefactos A→B/recovery y journal | activa |
