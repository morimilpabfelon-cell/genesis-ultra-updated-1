...
def main() -> int:
    ...
    step(2, "checkpoint completo creado y firmado por A", checkpoint_hash=checkpoint["checkpoint_hash"])
    ...
    step(4, "paquete canónico completo construido", package_digest=transfer_package["package_digest"])
    ...
    step(5, "B demuestra posesión de su clave", proof_digest=proof_digest, tamper_rejected=True)
